...
<template>
  <!--  <div
        class="grid grid-cols-12 m-5 cursor-pointer block max-w-sm bg-white rounded-lg border
        lg:m-2 pr-0 pl-4 w-full
        border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
      <div class="col-span-11 items-center pb-5 pt-2 h-32">
        <h5 class="mb-2 text-lg font-bold tracking-tight text-gray-900 dark:text-white text-right">
          {{ audio.englishName }}
        </h5>
      </div>
    </div>-->
  ...
  <div>
    <div :id="'player-index-'+(audio.id - 1)"
         class="relative w-player flex flex-col rounded-xl
         bg-player-light-background border border-player-light-border
         dark:shadow-player-dark dark:bg-player-dark-background
         dark:border-player-dark-border dark:backdrop-blur-xl">
      <div class="px-[15px] pt-[16px] pb-4 flex items-start z-50">
        <div class="flex flex-col w-full text-right mr-6">
          <span
        ...
        <span data-amplitude-song-info="name" :data-amplitude-song-index="audio.id - 1"
              class="w-40 h-19 rounded-md border text-[46px] text-center text-gray-400 grid place-items-center h-screen
             border-bg-player-light-background dark:border-cover-dark-border">
        </span>
      </div>
      <div class="w-full flex flex-col px-[15px] pb-[12px] z-50">
        <input type="range" id="song-percentage-played" class="amplitude-song-slider mb-3"
               :data-amplitude-song-index="audio.id - 1" step=".1"/>
        <div class="flex w-full justify-between">
          <span :data-amplitude-song-index="audio.id - 1"
                class="amplitude-current-time text-xs font-sans tracking-wide
              font-medium text-sky-500 dark:text-sky-300"></span>
          <span :data-amplitude-song-index="audio.id - 1"
                class="amplitude-duration-time text-xs font-sans tracking-wide font-medium text-gray-500"></span>
        </div>
      </div>
      <div
          class="h-control-panel px-[15px] rounded-b-xl bg-control-panel-light-background
          border-t border-gray-200 flex items-center justify-between
          z-50 dark:bg-control-panel-dark-background dark:border-gray-900">
<!--        <div :data-amplitude-song-index="audio.id - 1" class="cursor-pointer" id="song-saved">
        ...
        <div :data-amplitude-song-index="audio.id - 1" class="cursor-pointer amplitude-shuffle">
        ...
        <div :data-amplitude-song-index="audio.id - 1" class="cursor-pointer amplitude-prev">
        ...
        <div :data-amplitude-song-index="audio.id - 1"
             class="cursor-pointer amplitude-play-pause w-16 h-16
            rounded-full bg-white border border-play-pause-light-border
            shadow-md flex items-center justify-center dark:bg-play-pause-dark-background dark:border-play-pause-dark-border">
          <svg id="play-icon" class="ml-[7px]" width="24" height="28" viewBox="0 0 31 37" fill="none"
          ...
          <svg id="pause-icon" width="18" height="27" viewBox="0 0 24 36" fill="none"
               xmlns="http://www.w3.org/2000/svg">
        ...
        <div :data-amplitude-song-index="audio.id - 1" class="cursor-pointer amplitude-next">
          <svg width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <div :data-amplitude-song-index="audio.id - 1" class="cursor-pointer amplitude-repeat-song">
